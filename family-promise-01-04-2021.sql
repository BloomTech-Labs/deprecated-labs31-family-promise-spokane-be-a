...
COPY public.notes (id, family_id, author_id, subject, content, shareable, date, "time") FROM stdin;
1	1	00u2lgca4zIaSTPqE5d6	Please be aware of sensitive information	Family came in after fire destroyed their home, young Jacob is still in the recovering.	t	2020-12-14	2020-12-13 21:15:31.031-06
\.
